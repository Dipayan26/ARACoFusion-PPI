...
Description:   This script generated embeddings for Rice sequences.
'''
#########################################################################
...
if __name__ == "__main__":
    rice = "/Datasets/Processed/Rice/Rice_PPI.csv"

    seqs = load_all_sequences([rice])
